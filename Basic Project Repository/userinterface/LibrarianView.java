...
public class LibrarianView extends View {
    ...
    private GridPane createFormContents() {
        ...
        insertBookButton.setFont(Font.font("Garamond", FontWeight.NORMAL, 15));
        ...
        insertPatronButton.setFont(Font.font("Garamond", FontWeight.NORMAL, 15));
        ...
        searchBooksButton.setFont(Font.font("Garamond", FontWeight.NORMAL, 15));
        ...
        searchPatronsButton.setFont(Font.font("Garamond", FontWeight.NORMAL, 15));
        ...
        doneButton.setFont(Font.font("Garamond", FontWeight.NORMAL, 15));
